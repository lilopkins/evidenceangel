...
error-failed-open-body = Misslyckades att öppna bevispaketet: { $error }
error-failed-new-title = Misslyckades att Skapa Nytt Paket
error-failed-new-body = Misslyckades att skapa nytt bevispaket: { $error }
...
default-title = Namnlöst Bevispaket
default-author = Anonym Författare
default-case-title = Nytt Fall

nav-metadata = Metadata
nav-create-case = Skapa Testfall
nav-delete-case = Radera Testfall

title-no-package = Inget paket öppet
...
metadata-edit-id = Internt ID (valfritt)
...
test-status = Status
test-status-unset = Odefinerad
test-status-pass = Framgång
test-status-fail = Misslyckar
test-status-unset-display = Odefinerad
test-status-pass-display = ✅ Framgång
test-status-fail-display = ❌ Misslyckar
...
add-evidence-image-label = Bildsökväg
...
expand-image = Visa bild
expand-file = Visa fil
...
add-evidence-file-failed-message = Misslyckades att lägga till fil i paketet: { $error }
...
export-submit-replace = Skriv över
export-submit-save = Spara och Exportera
export-submit-save-replace = Spara och Skriv över
